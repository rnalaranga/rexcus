...
const target = `<div><h1 className="text-lg font-bold text-primary">Work Orders & Production Planning</h1><p className="text-xs text-muted mt-0.5">BOM, routing, machine allocation and shop floor tracking</p></div>`;
const replacement = `<div><h1 className="text-lg font-bold text-primary">Work Orders & Production Planning</h1><p className="text-xs text-muted mt-0.5">BOM, routing, machine allocation and shop floor tracking</p></div>
...
const tableStart = `<GlassCard className="p-0 overflow-hidden border border-theme-subtle">`;
